...
@register_model('doubly')
class DoublyModel(FairseqEncoderDecoderModel):
...
class TransformerEncoder(FairseqEncoder):
    ...
    def reorder_encoder_out(self, encoder_out, new_order):
        ...
        if encoder_out.visions is not None:
            encoder_out = encoder_out._replace(
                visions=encoder_out.visions.index_select(0, new_order)
            )
        return encoder_out
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def forward(
        ...
        """
        visions = encoder_out.visions
        batch_visual_ids = visions.type(torch.LongTensor).to(prev_output_tokens.device)
...
@register_model_architecture('doubly', 'doubly')
...
@register_model_architecture('doubly', 'doubly_iwslt_de_en')
...
@register_model_architecture('doubly', 'doubly_tiny')
def transformer_iwslt_de_en(args):
