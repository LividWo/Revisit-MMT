...
@register_model('image_gate')
class ImageGateModel(FairseqEncoderDecoderModel):
...
@register_model_architecture('image_gate', 'image_gate')
...
@register_model_architecture('image_gate', 'image_gate_iwslt_de_en')
...
@register_model_architecture('image_gate', 'image_gate_tiny')
def transformer_iwslt_de_en(args):
