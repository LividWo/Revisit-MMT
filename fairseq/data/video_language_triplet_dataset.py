...
def collate(
    ...
    # masks = torch.LongTensor([s['video_mask'] for s in samples])
    ...
    # masks = masks.index_select(0, sort_order)
...
class VideoLanguageTripletDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        ...
        video_item = self.video[index]

        # video, mask = load_video_features(os.path.join('data/vatex_features/', str(video_item) + '.npy'), 32)
